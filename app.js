...
const getPokemons = async (id) => {
  ...
  const createPokemonCard = (pokemon) => {
    ...
    const pokemonId = pokemon.id.toString().padStart(3, '0') //3 basamaklı olsun ve kalan kısımları 0 ile doldur dedik padStart komutu ile
    ...
    const pokemonInnerHTML = `
              ...
              <img
                src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemon.id}.png" //($işareti ile sırayla tüm fotoları getirmis olduk)
                alt="Pokemon 1 image"
              />
            </div>
            <div class="poke-info">
